# -*- coding: utf-8 -*-
"""all_post_type_graph_api

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IiEYHqCcSZ06M7IxfRYEWgFz3LPj9bYK
"""
...
params['client_id'] = '1637029270130540'                  # not an actual client id
params['client_secret'] = '17a5523b14ef004e1db268e28d4793a4'     # not an actual client secret
params['graph_domain'] = 'https://graph.facebook.com'
params['graph_version'] = 'v17.0'
params['endpoint_base'] = params['graph_domain'] + '/' + params['graph_version'] + '/'
params['page_id'] = '3366665810247776'                  # not an actual page id
params['instagram_account_id'] = '17841440491576448'        # not an actual instagram business account id
params['ig_username'] = 'vikas.kamwal'
...
key_path= "/content/yt-analysis-project-386610-e132dc9133a2.json"
project_id="yt-analysis-project-386610"
dataset_id = "yt-analysis-project-386610.ig_dataset"
table_id="yt-analysis-project-386610.ig_dataset.ig_metric_v2"
...
project_id="yt-analysis-project-386610"
dataset_id = "yt-analysis-project-386610.ig_dataset"
table_id="yt-analysis-project-386610.ig_dataset.story_insight"
print("********* NAME OF TABLE IS", table_id)
